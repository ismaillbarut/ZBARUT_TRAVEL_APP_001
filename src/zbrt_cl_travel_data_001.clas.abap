CLASS zbrt_cl_travel_data_001 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zbrt_cl_travel_data_001 IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA itab TYPE TABLE OF zbarut_trvl_001.
...
*   delete existing entries in the database table
    DELETE FROM zbarut_trvl_001.

*   insert the new table entries
    INSERT zbarut_trvl_001 FROM TABLE @itab.
