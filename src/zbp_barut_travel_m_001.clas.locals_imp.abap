CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    TYPES tt_travel_update TYPE TABLE FOR UPDATE zbarut_travel_m_001.
    ...
    METHODS TotalPrice FOR MODIFY
      IMPORTING keys FOR ACTION Travel~TotalPrice RESULT result.
...
**********************************************************************
* Seyahat örnekleri için dinamik özellik işlemeyi uygular
**********************************************************************
...
**********************************************************************
* Seyahat verilerini kaydederken müşteri verilerini doğrulayın
**********************************************************************
  ...
  METHOD calculatetravelkey.
    READ ENTITIES OF zbarut_travel_m_001 IN LOCAL MODE
         ENTITY Travel
           FIELDS ( travel_id )
    ...
    "Get max travelID
    SELECT SINGLE FROM zbarut_trvl_001 FIELDS MAX( travel_id ) INTO @DATA(lv_max_travelid).

    "update involved instances
    MODIFY ENTITIES OF zbarut_travel_m_001 IN LOCAL MODE
      ENTITY Travel
  ...
  METHOD set_status_completed.
    ...
    "Eylem sonucu için değiştirilen verileri okuyun
...
**********************************************************************
* Tarihin geçerliliğini kontrol edin
**********************************************************************
